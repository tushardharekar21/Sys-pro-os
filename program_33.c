//Q) Write a simulation program to implement non-pre-emptive Priority CPU scheduling algorithm. Accept the number
//  of Processes and arrival time, CPU burst time and priority for each process as input. Priorities should in High
//   to Low order (1 is High). The output should give the Gantt chart, turnaround time and waiting time for each 
