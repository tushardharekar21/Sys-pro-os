//Q) Write a program to implement a Banker‟s Algorithm. Accept the total number of processes (n) and resource
//  types (m) as input. Also accept the number of initial instances for each resource type. Allocation and Max
//   of size “nxm” as input and perform the following operations:
